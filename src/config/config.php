...
return [
     ...
     */
    'controller_stub'  => 'vendor/fromz/l5-api/src/Generator/stubs/controller.stub',

    /*
     * Relative path from the base directory to the route stub.
     */
    'route_stub'       => 'vendor/fromz/l5-api/src/Generator/stubs/route.stub',

    /*
     * Relative path from the base directory to the transformer stub.
     */
    'transformer_stub' => 'vendor/fromz/l5-api/src/Generator/stubs/transformer.stub',
];
